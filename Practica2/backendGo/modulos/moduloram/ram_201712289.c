...
static int __init _insert(void)
{
    ...
    proc_create_single("ram_201712289", 0, NULL, getRamInfo);
#else
    proc_create("ram_201712289", 0, NULL, &operaciones);
#endif
    printk(KERN_INFO "201712289\n");
    return 0;
}

static void __exit _remove(void)
{
    remove_proc_entry("ram_201712289", NULL);
