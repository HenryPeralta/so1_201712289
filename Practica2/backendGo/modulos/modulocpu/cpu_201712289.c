...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Henry Peralta");
MODULE_DESCRIPTION("Practica2");
...
static int __init _insert(void)
{
    ...
    proc_create_single("cpu_201712289", 0, NULL, getCpuInfo);
#else
    proc_create("cpu_201712289", 0, NULL, &operaciones);
#endif
    printk(KERN_INFO "Henry Gabriel Peralta Martinez\n");
    return 0;
}

static void __exit _remove(void)
{
    remove_proc_entry("cpu_201712289", NULL);
